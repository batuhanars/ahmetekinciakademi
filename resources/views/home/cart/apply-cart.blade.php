    ...
    <section class="layout-pt-md layout-pb-lg">
        ...
        <div class="container">
            <div class="row y-gap-50">
                <div class="col-lg-8">
                            ...
                            <a href="#" class="coursesCard -type-1 row y-gap-20 flex-row items-center">
                                <div class="col-xl-4 col-lg-4">
                                    <div class="coursesCard__image rounded-8 relative">
                                        <img class="w-1/1 rounded-8" src="{{ $item->course->image }}"
                                ...
                                <div class="col">
                                    <div class="d-flex items-center">
                                        <div class="text-14 lh-1 text-yellow-1 mr-10">{{ $item->course->sumRate() }}</div>
                                        <div class="d-flex x-gap-5 items-center">
                                            @for ($i = 0; $i < $item->course->sumRate(); $i++)
                                                <div class="icon-star text-9 text-yellow-1"></div>
                                            @endfor
                                        </div>
                                    </div>

                                    <div class="col-xl-7 text-17 lh-15 fw-500 text-dark-1 mt-10">{{ $item->course->title }}
                                    </div>
                                    <div class="mt-8" title="{{ $item->course->description }}">
                                        {{ Str::limit($item->course->description, 200) }}
                                    </div>

                                    <div class="row x-gap-10 y-gap-10 items-center pt-10">
                                        <div class="col-auto">
                                            <div class="d-flex items-center">
                                                @if ($item->course->instructor->image)
                                                    <img src="{{ $item->course->instructor->image }}"
                                                        alt="{{ $item->course->instructor->fullname }}" class="rounded-16"
                                                        style="width: 34px;">
                                                @else
                                                    <span
                                                        class="uppercase bg-black px-2 rounded-16 text-white">{{ Str::limit($item->course->instructor->fullname, 1, '') }}</span>
                                                @endif
                                                <div class="ml-10">{{ $item->course->instructor->fullname }}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="d-flex items-center">
                                                <img class="mr-8"
                                                    ...
                                                    alt="icon">
                                                <div class="text-14 lh-1">{{ $item->course->lessonCount() }} ders</div>
                                            </div>
                                        </div>
                    ...
                    <div style="box-shadow: 0 0 5px #bdc3c7; padding:20px; margin-top: 50px;" class="rounded-8">
                        ...
                        <div style="margin-top:50px; height: 400px; overflow-y:auto;">
                            ...
                            <div style="text-align:start;" class="para"><span
                                    style="--darkmode-color: rgb(247, 248, 248); --lightmode-color: rgb(44, 47, 52);"
                                    class="UrtAp">Hizmet:&nbsp; @foreach ($cart as $item)
                                        {{ $item->course->title . ',' }}
                                    @endforeach
                                </span></div>
                            <div style="text-align:start;" class="para"><span
                                    style="--darkmode-color: rgb(247, 248, 248); --lightmode-color: rgb(44, 47, 52);"
                                    class="UrtAp">Satış Fiyatı:&nbsp;{{ $total }}₺</span></div>
                            <strong style="text-align:start;"><span
                                    style="--darkmode-color: rgb(247, 248, 248); --lightmode-color: rgb(44, 47, 52);"
                                    class="UrtAp">5.
                ...
                <div class="col-lg-4">
                    <form action="{{ route('home.cart-checkout') }}" method="post">
                        @csrf
                        <div class="">
                            <div class="pt-30 pb-15 bg-white border-light rounded-8 bg-light-4">
                                ...
                                @foreach ($cart as $item)
                                    <div class="d-flex justify-between border-top-dark px-30">
                                        <div class="py-15 text-grey">{{ $item->course->title }}</div>
                                        <div class="py-15 text-grey">{{ $item->course->price }}₺</div>
                                    </div>
                                @endforeach
