...
<head>
    ...
    <meta name="copyright" content="Marka Press"><!-- Sayfayı Hazırlayan Firma-->
                        ...
                        <div class="header-left d-flex items-center">
                            ...
                            <div class="header__logo">
                                <a data-barba href="index.html">
                                    <img src="{{ $general->dark_logo }}" alt="{{ $general->title }}" width="175">
                                </a>
                            </div>
                                ...
                                <div class="header-menu__content">
                                        ...
                                        @if (auth()->user())
                                            ...
                                            @else
                                                <a href="{{ route('account.index') }}"
                                                    class="button px-25 h-50 -dark-2 text-white ml-20">Hesabım</a>
                                            @endif
                                        @else
                                            <a href="{{ route('customer.login') }}" class="text-dark-1">Giriş
                                                Yap</a>
                                    ...
                                    <div class="mobile-footer px-20 py-20 border-top-light js-mobile-footer">
                                        <div class="mobile-footer__number">
                                            <div class="text-17 fw-500 text-dark-1">Telefon</div>
                                ...
                                @if (auth()->user())
                                    @if (auth()->user()->membership_type != 'customer')
                                        <a href="{{ route('customer.login') }}"
                                            class="button -underline text-dark-1">Giriş
                                            Yap</a>
