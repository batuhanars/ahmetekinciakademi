...
<head>
    <base href="../../../">
    <title>Telefon Doğrula | ahmetekinciakademi</title>
    <meta charset="utf-8" />
    ...
    <div class="d-flex flex-column flex-root" style="background: #181C32">
        ...
        <div
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                ...
                <!--end::Logo-->
                <!--begin::Wrapper-->
                <div style="border-radius: 10px !important;" class="bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form class="form w-100" id="kt_sign_in_form" action="{{ route('panel.verify-mobile.post') }}"
                        method="post">
                        @csrf
                        <!--begin::Heading-->
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="form-label fs-6 fw-bolder text-dark">Doğrulama Kodu</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <span class="text-danger d-block">{{ $errors->first('mobile_verify_code') }}</span>
                            <input class="form-control form-control-lg form-control-solid" type="text"
                                name="mobile_verify_code" autocomplete="off" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Actions-->
                        <div class="text-center">
                            ...
                            <button type="submit" style="background: #008aff; border-radius: 6px;"
                                ...
                                <span class="indicator-label text-white">Doğrula</span>
                            </button>
                            <!--end::Submit button-->
                        </div>
                        <!--end::Actions-->
