                    ...
                    <div class="card-title">
                        ...
                        <form>
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                @if (request()->get('ders'))
                                    <a href="{{ route('panel.courses.playlists.index') }}" class="btn  btn-light">
    ...
    <div class="modal fade" tabindex="-1" id="addPlaylist">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('panel.courses.playlists.store', $course) }}" method="post">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" id="selectList">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('panel.courses.playlists.select', $course) }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group mb-5">
