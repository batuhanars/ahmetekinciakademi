                            ...
                            <div class="scroll-y me-n5 pe-5 h-200px h-lg-auto" data-kt-scroll="true"
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-45px symbol-circle">
                                            <img alt="Pic" src="{{ asset('assets/back') }}/media/avatars/300-1.jpg" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Details-->
                                        <div class="ms-5">
                            ...
                            <div class="scroll-y me-n5 pe-5 h-300px h-lg-auto" data-kt-element="messages"
                                ...
                                <div class="d-flex justify-content-start mb-10">
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        ...
                                        <div class="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start"
                                            data-kt-element="message-text">How likely are Siz to recommend our company to
                                            Sizr friends and family ?</div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Wrapper-->
                                </div>
                                    ...
                                    <div class="d-flex flex-column align-items-end">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div class="me-3">
                                                ...
                                                <a href="#"
                                                    class="fs-5 fw-bolder text-gray-900 text-hover-primary ms-1">Siz</a>
                                            </div>
                                            <!--end::Details-->
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                        ...
                                        <div class="p-5 rounded bg-light-primary text-dark fw-bold mw-lg-400px"
                                            data-kt-element="message-text">Hey there, we’re just writing to let Siz know
                                            that Siz’ve been subscribed to a repository on GitHub.</div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Wrapper-->
                                </div>
                                ...
                                <div class="d-flex justify-content-end mb-10">
                                    ...
                                    <div class="d-flex flex-column align-items-end">
                                        ...
                                        <!--begin::Text-->
                                        <div class="p-5 rounded bg-light-primary text-dark fw-bold mw-lg-400px"
                                            data-kt-element="message-text">Siz’ll receive notifications for all issues,
                                            pull requests!</div>
                                        <!--end::Text-->
                                    </div>
                                    <!--end::Wrapper-->
                                ...
                                <div class="d-flex justify-content-start mb-10">
                                    ...
                                    <div class="d-flex flex-column align-items-start">
                                        ...
                                        <!--begin::Text-->
                                        <div class="p-5 rounded bg-light-info text-dark fw-bold mw-lg-400px text-start"
                                            data-kt-element="message-text">Siz can unwatch this repository immediately by
                                            clicking here:
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="text-center mb-13">
                                ...
                                <!--end::Title-->
                                <!--begin::Description-->
                                <div class="text-muted fw-bold fs-5">If Siz need more info, please check out our
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="fw-bold">
                                    ...
                                    <div class="fs-7 text-muted">If Siz need more info, please check budget planning</div>
                                </div>
                                <!--end::Label-->
                                <!--begin::Switch-->
                                ...
                                <div class="py-5">
                                    ...
                                    <div data-kt-search-element="empty" class="text-center d-none">
                                        ...
                                        <div class="text-center px-5">
                                            <img src="{{ asset('') }}/media/illustrations/unitedpalms-1/1.png"
        ...
        Vue.createApp({
            ...
            methods: {
                detailMessage(message) {
                    ...
                    this.customer = message.customer.user;
                },
                detailAnswer(message, answer) {
                    this.message = message;
                    this.answer = answer;
                },
