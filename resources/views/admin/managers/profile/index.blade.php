        ...
        <div id="kt_content_container" class="container-fluid">
            @include('admin.breadcrumb', [
                'items' => [
                    ...
                    [
                        'link' => route('panel.managers.index'),
                        'title' => 'Yöneticiler',
                    ],
                    [
                        'link' => '',
            ...
            <div class="row">
                @include('admin.managers.profile.include.profile-card')
                <div class="col-md-9">
                    <div class="card card-custom card-stretch">
                        <div class="card-header py-3">
                            <div class=" align-items-start flex-column">
                                <h3 class="card-title fw-bolder text-dark">Profil Bilgileri</h3>
                                <span class="text-muted fw-bold fs-sm mt-1">Yöneticiye ait profil bilgileri.</span>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            @if ($user->membership_type == 'superadmin')
                                <div class="form-group mb-5 row">
                        ...
                        <div class="card card-custom card-stretch mt-10">
                            <div class="card-header py-3">
                                <div class=" align-items-start flex-column">
                                    ...
                                    <span class="text-muted fw-bold fs-sm mt-1">Yöneticiye ait sosyal medya
                                        hesapları.</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row"><label class="col-xl-3"></label>
                                    <div class="input-group mb-5">
                                        ...
                                        <input readonly type="text" name="facebook" id="facebook"
                                            ...
                                            value="{{ $user->instructor->facebook }}">
                                    </div>
                                    <div class="input-group mb-5">
                                        <div class="input-group-append">
                                    ...
                                    <div class="input-group mb-5">
                                        ...
                                        <input readonly type="text" name="linkedin" id="linkedin"
                                            class="form-control form-control-solid"
                                            value="{{ $user->instructor->linkedin }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card card-custom card-stretch mt-10">
                            <div class="card-header py-3">
                                <div class=" align-items-start flex-column">
                                    ...
                                    <span class="text-muted fw-bold fs-sm mt-1">Yönetici hakkında.</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row"><label class="col-xl-3"></label>
