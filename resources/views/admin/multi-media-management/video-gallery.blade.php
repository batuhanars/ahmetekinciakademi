...
@section('navigation')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('panel.video-gallery.index') }}" class="text-muted text-hover-primary">Ahmet Ekinciye Ait
                Videolar</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('panel.all-videos.index') }}" class="text-muted text-hover-primary">Tüm Videolar</a>
        </li>
        <!--end::Item-->
    </ul>
@endsection
                    ...
                    <div class="card-title">
                        ...
                        <form>
                            <div class="d-flex align-items-center">
                                ...
                                @if (Request::routeIs('panel.all-videos.index'))
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <span class="svg-icon svg-icon-1 position-absolute ms-4">
                                            <i class="fas fa-search"></i>
                                        </span>
                                ...
                                @endif
                                @if (request()->get('video') || request()->get('egitmen'))
                                    <a href="{{ Request::routeIs('panel.video-gallery.index') ? route('panel.video-gallery.index') : route('panel.all-videos.index') }}"
                                        class="btn  btn-light">
    ...
    <div class="modal fade" tabindex="-1" id="addVideo">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('panel.video-gallery.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
