...
@section('navigation')
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('panel.playlists.index') }}" class="text-muted text-hover-primary">Ahmet Ekinciye Ait
                Oynatma Listesi</a>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('panel.all-playlists.index') }}" class="text-muted text-hover-primary">Tüm Oynatma Listesi</a>
        </li>
        <!--end::Item-->
    </ul>
@endsection
                        ...
                        <form>
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" name="oynatma-listesi"
                                        class="form-control form-control-solid w-250px ps-14 me-5"
                                        value="{{ request()->get('oynatma-listesi') }}"
                                        placeholder="Oynatma Listesi Ara..." />
                                </div>
                                @if (Request::routeIs('panel.all-playlists.index'))
                                    <div class="d-flex align-items-center position-relative my-1">
                                        <span class="svg-icon svg-icon-1 position-absolute ms-4">
                                            <i class="fas fa-search"></i>
                                        </span>
                                ...
                                @endif
                                @if (request()->get('oynatma-listesi') || request()->get('egitmen'))
                                    <a href="{{ Request::routeIs('panel.playlists.index') ? route('panel.playlists.index') : route('panel.all-playlists.index') }}"
                                        class="btn  btn-light">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach ($playlists as $playlist)
                                <tr class="odd">
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('panel.playlists.video.index', $playlist) }}"
    ...
    <div class="modal fade" tabindex="-1" id="addPlaylist">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('panel.playlists.store') }}" method="post">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" id="editPlaylist">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form :action="'/sistem/oynatma-listesi/' + playlist.id" method="post">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        {{-- <div class="form-group mb-5">
                ...
                deletePlaylist(playlist) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "GET",
                                url: "/sistem/oynatma-listesi/" + playlist.id + "/sil",
                                success: function() {
                                    Swal.fire({
                                        icon: "success",
                                        title: "Silindi",
