                        ...
                        <form>
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                @if (request()->get('yorum'))
                                    <a href="{{ route('instructor.customer-feedbacks.index') }}" class="btn  btn-light">
    ...
    <div class="modal fade" tabindex="-1" id="editFeedback">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form :action="'/panel/musteri-gorusleri/' + feedback.id" method="post">
                    @csrf
                    @method('PUT')
                ...
                deleteFeedback(feedback) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "GET",
                                url: "/panel/musteri-gorusleri/" + feedback.id + "/sil",
                                success: function() {
                                    Swal.fire({
                                        icon: "success",
                                        title: "Silindi",
