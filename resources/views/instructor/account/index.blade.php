...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            ...
            <!--begin::Navbar-->
            @include('instructor.account.include.profile-card')
            <!--end::Navbar-->
            <!--begin::Basic info-->
            <form action="{{ route('instructor.account.update') }}" id="kt_account_profile_details_form" class="form"
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-bold fs-6">Eğitim Durumu</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="education_status"
                                        class="form-control form-control-lg form-control-solid"
                                        value="{{ auth()->user()->instructor->education_status }}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-bold fs-6">Öz Geçmiş</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8">
            ...
            <form action="{{ route('instructor.account.social-media.update') }}" method="post">
                @csrf
                @method('PUT')
                <div class="card mb-5 mb-xl-10">
                    <!--begin::Card header-->
                        ...
                        <div class="card-body border-top p-9">
                            <div class="input-group mb-5">
                                ...
                                <input type="text" name="facebook" id="facebook"
                                    class="form-control form-control-solid" value="{{ auth()->user()->facebook }}">
                            </div>
                            <div class="input-group mb-5">
                                <div class="input-group-append">
                                ...
                                <input type="text" name="twitter" id="twitter"
                                    class="form-control form-control-solid" value="{{ auth()->user()->twitter }}">
                            </div>
                            <div class="input-group mb-5">
                                <div class="input-group-append">
                                ...
                                <input type="text" name="instagram" id="instagram"
                                    class="form-control form-control-solid" value="{{ auth()->user()->instagram }}">
                            </div>
                            <div class="input-group mb-5">
                                <div class="input-group-append">
                                ...
                                <input type="text" name="linkedin" id="linkedin"
                                    class="form-control form-control-solid" value="{{ auth()->user()->linkedin }}">
                            </div>
                        </div>
                        <!--end::Card body-->
                        <!--end::Form-->
            ...
            <form action="{{ route('instructor.account.about.update') }}" method="post">
                @csrf
                @method('PUT')
                <div class="card mb-5 mb-xl-10">
                    <!--begin::Card header-->
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        ...
                        <div class="card-body border-top p-9">
                            <div class="form-group">
                                <textarea name="about" class="form-control form-control-solid" rows="4" data-kt-autosize="true">{{ auth()->user()->about }}</textarea>
                            </div>
                        </div>
                        <!--end::Card body-->
                        <!--end::Form-->
            ...
            <form action="{{ route('instructor.account.change-password') }}" method="post">
                @csrf
                @method('PUT')
                <div class="card mb-5 mb-xl-10">
                    <!--begin::Card header-->
