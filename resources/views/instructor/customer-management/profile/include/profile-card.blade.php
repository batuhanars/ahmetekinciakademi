        ...
        <div class="card-body pt-4">
            <div class="d-flex align-items-center">
                <div class="symbol symbol-60px symbol-xxl-100px me-5">
                    <div class="symbol me-3">
                        ...
                        @else
                            <span class="symbol-label fs-1">R</span>
                        @endif
                    </div>
            ...
            <div class="menu menu-dark menu-hover-primary menu-hover-bg menu-active-primary menu-active-bg menu-column">
                <div class="menu-item mb-2">
                    <a href="{{ route('instructor.customers.profile.info', $user) }}"
                        class="menu-link py-4 {{ Request::routeIs('instructor.customers.profile.info') ? 'active' : '' }}"
                ...
                <div class="menu-item mb-2">
                    <a href="{{ route('instructor.customers.invoice.info', $user) }}"
                        class="menu-link py-4 {{ Request::routeIs('instructor.customers.invoice.info') ? 'active' : '' }}"
                        style="cursor: pointer;">
                        <span class="menu-icon me-2">
                            <span class="svg-icon">
                ...
                <div class="menu-item mb-2">
                    <a href="{{ route('instructor.customers.invoices', $user) }}"
                        class="menu-link py-4 {{ Request::routeIs('instructor.customers.invoices') ? 'active' : '' }}"
                        style="cursor: pointer;">
                        <span class="menu-icon me-2">
                            <span class="svg-icon">
                ...
                <div class="menu-item mb-2">
                    <a href="{{ route('instructor.customers.education.info', $user) }}"
                        class="menu-link py-4 {{ Request::routeIs('instructor.customers.education.info') ? 'active' : '' }}"
                        style="cursor: pointer;">
                        <span class="menu-icon me-2">
                            <span class="svg-icon">
                ...
                <div class="menu-item mb-2">
                    <a href="{{ route('instructor.customers.certificates', $user) }}"
                        class="menu-link py-4 {{ Request::routeIs('instructor.customers.certificates') ? 'active' : '' }}"
                        style="cursor: pointer;">
                        <span class="menu-icon me-2">
                            <span class="svg-icon">
