        ...
        <div id="kt_content_container" class="container-fluid">
            @include('admin.breadcrumb', [
                'items' => [
                    ...
                    [
                        'link' => route('instructor.playlists.index'),
                        ...
                        <form>
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                @if (request()->get('video'))
                                    <a href="{{ route('instructor.playlists.video.index') }}" class="btn  btn-light">
    ...
    <div class="modal fade" tabindex="-1" id="addVideo">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('instructor.playlists.video.store', $playlist) }}" method="post"
    ...
    <div class="modal fade" tabindex="-1" id="selectList">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('instructor.playlists.video.select', $playlist) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="form-group mb-5">
                ...
                removeVideo(video) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "GET",
                                url: "/panel/oynatma-listesi/" + {{ $playlist->id }} +
                                    '/video/' +
                                    video.id,
                                success: function() {
                                    Swal.fire({
