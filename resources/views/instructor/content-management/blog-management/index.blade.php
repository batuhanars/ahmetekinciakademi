            ...
            <div class="card card-flush">
                <div class="card-header align-items-center gap-2 gap-md-5">
                        ...
                        <form>
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                @if (request()->get('haber'))
                                    <a href="{{ route('instructor.blog.index') }}" class="btn  btn-light">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <a href="{{ route('instructor.blog.create') }}" class="btn btn-light-primary">
                            ...
                            @foreach ($blogs as $blog)
                                <tr class="odd">
                                    <td class="d-flex align-items-center">
                                        ...
                                        <a href="#" class="text-dark text-hover-primary ms-5">{{ $blog->title }}</a>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('instructor.blog.edit', $blog) }}"
                ...
                deleteBlog(blog) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "GET",
                                url: "/panel/haberler/" + blog.id + "/sil",
                                success: function() {
                                    Swal.fire({
                                        icon: "success",
                                        title: "Silindi",
