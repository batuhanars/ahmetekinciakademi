                        ...
                        <form>
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                @if (request()->get('belge'))
                                    <a href="{{ route('instructor.documents.index') }}" class="btn  btn-light">
    ...
    <div class="modal fade" tabindex="-1" id="addDocument">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('instructor.documents.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" id="editDocument">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form :action="'/panel/belgeler/' + document.id" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="row">
