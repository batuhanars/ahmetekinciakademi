                        ...
                        <form>
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                @if (request()->get('sertifikae'))
                                    <a href="{{ route('instructor.certificates.index') }}" class="btn  btn-light">
    ...
    <div class="modal fade" tabindex="-1" id="addCertificate">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('instructor.certificates.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" id="editCertificate">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form :action="'/panel/sertifikalar/' + certificate.id" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="row">
                ...
                deleteCertificate(certificate) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "GET",
                                url: "/panel/sertifikalar/" + certificate.id + "/sil",
                                success: function() {
                                    Swal.fire({
                                        icon: "success",
                                        title: "Silindi",
