...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="author" content="Batuhan Arslan Web Developer">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="{{ route('instructor.index') }}" class="mt-6">
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-2 py-5 py-lg-8" id="kt_aside_menu_wrapper"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.index') }}" class="menu-link active">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.customers.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.invoices.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.course-sales') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.blog.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.documents.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.certificates.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            {{-- <div class="menu-item">
                                <a href="{{ route('instructor.image-gallery.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.video-gallery.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.playlists.index') }}" class="menu-link">
                                    <span class="menu-icon">
                                        <i class="text-white bi bi-collection-play fs-3"></i>
                                    </span>
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.messages.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.customer-feedbacks.index') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.multi-sms') }}" class="menu-link">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <a href="{{ route('instructor.sms.logs') }}" class="menu-link">
                                    <span class="menu-icon">
                                ...
                                <div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                        ...
                                        <div class="menu-item px-5 my-1">
                                            <a href="{{ route('instructor.account') }}" class="menu-link px-5">Hesap
                                                Ayarları</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                    ...
                    <div class="container-fluid d-flex flex-column align-items-center">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="" target="_blank"
                                class="text-gray-800 text-hover-primary">ahmetekinci.com.tr</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
