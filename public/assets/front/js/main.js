...
-------------------------------------------------------------------*/
    ...
    function dashboardSidebarSwitch() {
        ...
        buttons.forEach((el) => {
            el.addEventListener("click", () => {
                ...
                const openedMenu = target.querySelector(
                    ".-sidebar-menu-opened"
                );
    ...
    function pinOnScroll() {
        ...
        target.forEach((el) => {
            ...
            const sceneOffset =
                el.querySelector(".js-pin-content").offsetHeight + 70;
        ...
        target.forEach((el) => {
            ...
            items.forEach((el) => {
                el.addEventListener("click", (e) => {
                    ...
                    const allActiveDD =
                        document.querySelectorAll(".-is-dd-active");
                    if (allActiveDD) {
                        allActiveDD.forEach((el) =>
                            el.classList.remove("-is-dd-active")
                        );
    ...
    function shopSlider() {
        const slider = document.querySelector(
            ".js-shop-slider .js-slider-slider"
        );
            ...
            navBtnListBack.forEach((el) => {
                el.addEventListener("click", () => {
                    ...
                    menuListStepAnimate(
                        ...
                        parentList,
                        menuDeepLevel,
                        parentList.parentElement.querySelector("li > a")
                            .innerHTML
                    );
                });
            });
        ...
        function initial() {
            gsap.registerEffect({
                ...
                effect: (target, config) => {
                    ...
                    if (
                        !document.body.classList.contains("preloader-visible")
                    ) {
