...
Score.prototype = {
            ...
            switch (options[i]["type"]) {
                ...
                case "keyboard":
                    if ("keyboard" in options[i]) {
                        optionMatches = this.collectKeyboardMatches(
                            options[i]["keyboard"]
                        );
                    }
                    break;
    ...
    calculateKeyboardEntropy: function (original, turns, keyboard) {
        ...
        return (
            this.lg(possiblities) + turns * this.lg(keyboard.averageNeighbours)
        );
    },
    ...
    collectRepetitionMatches: function () {
        ...
        for (var i = 0; i < singleMatches.length; i++) {
            matches[matches.length] = {
                ...
                entropy: this.calculateSingleRepetitionEntropy(
                    singleMatches[i]
                ),
                start: this.password.indexOf(singleMatches[i]),
                end:
                    this.password.indexOf(singleMatches[i]) +
                    singleMatches[i].length -
                    1,
                type: "repetition",
            };
        }
        ...
        for (var i = 0; i < groupMatches.length; i++) {
            matches[matches.length] = {
                ...
                start: this.password.indexOf(groupMatches[i]),
                    ...
                    this.password.indexOf(groupMatches[i]) +
                    groupMatches[i].length -
                    1,
                type: "repetition",
            };
        }
        ...
        if (lowerRevSeq.length > 0) {
            matches[matches.length] = {
                ...
                start: this.password.indexOf(lowerRevSeq),
                    ...
                    this.password.indexOf(lowerRevSeq) + lowerRevSeq.length - 1,
                type: "sequence",
            };
        }
        ...
        if (numberRevSeq.length > 0) {
            matches[matches.length] = {
                ...
                start: this.password.indexOf(numberRevSeq),
                    ...
                    this.password.indexOf(numberRevSeq) +
                    numberRevSeq.length -
                    1,
                type: "sequence",
            };
