...
class CustomerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("admin.customer-management.index", compact("users", "certificates"));
    }

    public function profileInfo(User $user)
    {
        $customer = $user->customer;
        return view("admin.customer-management.profile.index", compact("user", "customer"));
    }
    ...
    public function profileInfoUpdate(Request $request, User $user)
    {
        ...
        return redirect()->route("panel.customers.profile.info", $user)->withSuccess("Üyelik bilgileri başarıyla güncellendi!");
    }
    ...
    public function invoiceInfo(User $user)
    {
        ...
        return view("admin.customer-management.profile.invoice-infos", compact("user", "provinces", "districts", "customer"));
    }
    ...
    public function invoiceInfoUpdate(Request $request, User $user)
    {
        ...
        return redirect()->route("panel.customers.invoice.info", $user)->withSuccess("Fatura bilgileri başarıyla güncellendi!");
    }
    ...
    public function invoices(User $user)
    {
        ...
        return view("admin.customer-management.profile.invoices", compact("user", "invoices", "customer"));
    }
    ...
    public function educationInfo(User $user)
    {
        ...
        return view("admin.customer-management.profile.education-infos", compact("user", "courses", "customer", "documents"));
    }
    ...
    public function certificates(User $user)
    {
        ...
        return view("admin.customer-management.profile.certificates", compact("user", "certificates", "customer"));
    }
